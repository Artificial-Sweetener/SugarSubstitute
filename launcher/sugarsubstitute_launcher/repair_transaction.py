...
from sugarsubstitute_shared.repair_recovery.journal import (
    PENDING_JOURNAL,
...
class RepairTransaction:
    ...
    def execute(
        ...
        *,
        ...
        with installation_mutation(plan.install_root, ownership=ownership) as mutation:
            ...
            if not identifier or any(
                ...
                raise RepairTransactionError(
                    "Repair transaction identifier is invalid."
                )
            ...
            try:
                for operation, record in zip(
                    transaction_operations, records, strict=True
                ):
                ...
                try:
                    recover_interrupted_repair(root, ownership=mutation)
