...
REVIEWED_CRASH_BOUNDARY_ROWS: tuple[CrashBoundaryInventoryRow, ...] = (
    ...
    ("process", "launcher/sugarsubstitute_launcher/crash_supervisor.py", "_start_crash_reporter", "subprocess.Popen", 1, "independent_crash_reporter"),
    ...
    ("qt_thread", "launcher/sugarsubstitute_launcher/ui/model_onboarding_execution.py", "QtModelOnboardingExecutor._start", "PySide6.QtCore.QThread", 1, "signal_reported_install_worker"),
