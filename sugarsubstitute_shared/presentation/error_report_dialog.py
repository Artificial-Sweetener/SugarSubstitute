...
"""Render structured user-facing reports in one shared QFluent dialog."""
...
class SharedErrorReportDialog(FullWindowModalBase):
    ...
    def _build_details(self) -> None:
        ...
        self._details_button = PushButton("", self.widget)
    ...
    def _build_actions(self) -> None:
        ...
        self._copy_button = PushButton("", self.buttonGroup)
        ...
        if self._issue_action is not None:
            self._report_issue_button = PushButton("", self.buttonGroup)
            apply_application_text(
        ...
        self._close_button = close_button_type("", self.buttonGroup)
        ...
        if self._restart is not None:
            self._restart_button = PrimaryPushButton("", self.buttonGroup)
            apply_application_text(
