...
"""Share Fluent-style motion tokens and reduced-motion policy."""
...
FLUENT_FASTER_DURATION_MS = 83
FLUENT_FAST_DURATION_MS = 167
FLUENT_NORMAL_DURATION_MS = 250
...
CANVAS_TOOL_INDICATOR_EXTEND_DURATION_MS = 120
CANVAS_TOOL_INDICATOR_SETTLE_DURATION_MS = 240
...
CONTEXTUAL_TOOLBAR_DURATION_MS = 180
...
FLUENT_ENTRANCE_EASING_CURVE = _build_cubic_bezier_curve(0.0, 0.0, 0.0, 1.0)
FLUENT_EXIT_EASING_CURVE = _build_cubic_bezier_curve(1.0, 0.0, 1.0, 1.0)
FLUENT_POINT_TO_POINT_EASING_CURVE = _build_cubic_bezier_curve(
    0.55,
    0.55,
    0.0,
    1.0,
