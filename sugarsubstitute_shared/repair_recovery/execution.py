...
def recover_interrupted_repair(
    install_root: Path, *, ownership: InstallationMutationOwnership | None = None
) -> bool:
    """Resume rollback or finish committed cleanup without repeating completed moves."""

    with installation_mutation(install_root, ownership=ownership):
