...
"""Test wildcard diagnostics and autocomplete presentation ownership."""
...
def _diagnostics_presentation(
    ...
    *,
    ...
    """Return a wildcard diagnostics owner with deterministic feature gates."""
...
def test_wildcard_diagnostics_prepares_provider_when_syntax_enabled() -> None:
    ...
    controller = _diagnostics_presentation((PromptEditorFeature.WILDCARD_SYNTAX,))
...
def test_wildcard_diagnostics_disables_provider_without_wildcard_syntax() -> None:
    ...
    controller = _diagnostics_presentation(())
