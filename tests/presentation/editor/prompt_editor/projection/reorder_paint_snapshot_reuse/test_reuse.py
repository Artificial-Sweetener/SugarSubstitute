...
def test_reorder_paint_snapshot_reuse_translates_unclipped_scroll_content() -> None:
    """Translate interior fragments while retaining immutable content identity."""
...
def test_reorder_paint_snapshot_reuse_rebuilds_viewport_edge_content() -> None:
    """Rebuild clipped edge fragments against the current viewport."""
...
def _key(*, scroll_offset: int) -> PromptReorderProjectionSnapshotKey:
    """Return deterministic preview paint keys."""
...
def _snapshot(
    *,
    ...
    """Return deterministic text-only paint snapshots."""
