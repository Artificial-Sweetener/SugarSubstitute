...
"""Verify prompt reorder preview synchronization contracts."""
...
def _layout(*indices: int) -> PromptReorderLayoutView:
    """Build one single-row reorder layout for preview synchronization."""
...
def _state(*indices: int) -> PromptReorderStateView:
    """Build one same-row reorder state for preview synchronization."""
