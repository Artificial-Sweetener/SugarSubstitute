...
"""Contract tests for pure prompt-projection layout algorithms."""
...
def test_projection_layout_algorithms_import_no_qt_or_application_services() -> None:
    ...
    forbidden_roots = {
        ...
        "tests.support.prompt_editor.projection_engine_support",
        "tests.support.prompt_editor.projection_surface_support",
    }
