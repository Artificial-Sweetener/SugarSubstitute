...
"""Cover pointer and keyboard reorder displacement session ownership."""
...
def test_displacement_session_records_held_segment_and_start_rects() -> None:
    """Preserve held identity and pre-layout rectangles for target changes."""
...
def test_displacement_session_consumes_only_matching_target() -> None:
    """Reject stale target changes instead of building animation plans."""
...
def test_displacement_session_clear_preserves_generation_watermarks() -> None:
    """Keep generation watermarks monotonic while clearing displacement state."""
