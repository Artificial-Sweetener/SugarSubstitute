...
def test_rebuild_active_override_controls_removes_inactive_controls(
    ...
    removed_label, removed_widget = manager._toolbar_registry.controls["cfg"]
...
def test_rebuild_active_override_controls_reorders_reused_controls(
    ...
    manager.sync_state_from_workflow()
    manager.rebuild_active_override_controls()
    seed_control = manager._toolbar_registry.controls["seed"]
    cfg_control = manager._toolbar_registry.controls["cfg"]
    ...
    assert manager._toolbar_registry.controls["seed"] == seed_control
    assert manager._toolbar_registry.controls["cfg"] == cfg_control
...
def test_rebuild_active_override_controls_inserts_after_layout_anchor(
    ...
    seed_label, seed_widget = manager._toolbar_registry.controls["seed"]
...
def test_rebuild_active_override_controls_replaces_changed_field_contract(
    ...
    manager.sync_state_from_workflow()
    manager.rebuild_active_override_controls()
    old_label, old_widget = manager._toolbar_registry.controls["seed"]
    ...
    assert manager._toolbar_registry.controls["seed"] != (old_label, old_widget)
