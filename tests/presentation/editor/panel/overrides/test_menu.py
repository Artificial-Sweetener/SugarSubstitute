...
class _DummyAction:
    ...
    def setData(self, data: object | None) -> None:
...
def _install_override_menu_renderer(monkeypatch: pytest.MonkeyPatch) -> None:
    """Replace only the manager's menu-renderer boundary."""
...
def test_rebuild_override_menu_uses_behavior_snapshot_candidates(
