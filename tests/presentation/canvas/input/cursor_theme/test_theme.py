...
def _app() -> QApplication:
    """Return the shared Qt application required for cursor construction."""
...
def test_input_cursor_theme_defers_non_branded_feedback() -> None:
    """Defer unthemed cursor families to CuteCanvas."""
...
def test_selection_translation_cursor_is_cached_and_dpr_aware() -> None:
    """Preserve logical size, hotspot, and cache identity across DPR requests."""
...
def test_move_cursor_switches_from_arrows_to_scissors_without_losing_hotspot() -> None:
    """Distinguish normal movement from selected-pixel lift semantics."""
...
def test_move_cut_cursor_normalizes_transient_invalid_display_scale() -> None:
    """Avoid unpaintable cursor images when a transient DPR is zero."""
