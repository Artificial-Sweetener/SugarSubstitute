...
"""Verify workflow-owned Input mask structure is protected from user undo."""
...
def test_input_mask_survives_undo_beyond_every_user_edit(
...
def test_loaded_input_mask_is_not_document_admission_history(
    tmp_path: Path,
    input_document_factory: InputDocumentFactory,
) -> None:
