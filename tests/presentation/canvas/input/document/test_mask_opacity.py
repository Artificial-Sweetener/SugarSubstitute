...
def test_real_cutecanvas_history_undoes_one_node_opacity_gesture_atomically(
    input_document_factory: InputDocumentFactory,
) -> None:
...
def test_node_opacity_undo_reconciles_document_workflow_and_card_state(
    input_document_factory: InputDocumentFactory,
) -> None:
...
def test_real_groove_drag_undoes_once_and_resynchronizes_complete_control(
    input_document_factory: InputDocumentFactory,
) -> None:
