...
def titlebar_controller_qt_application() -> Iterator[QApplication]:
    """Keep one worker-local Qt application alive for controller tests."""
...
def _wait_for_expansion(expansion: QSignalSpy) -> None:
    """Wait for the button's bounded expansion-completion contract."""
