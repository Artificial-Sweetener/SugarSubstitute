...
def test_closable_dock_widget_hides_and_emits_closed_signal() -> None:
    """Hide the dock and notify listeners without accepting close destruction."""
...
def test_handle_dock_closed_redocks_floating_dock() -> None:
    """Redock and reveal floating docks after a user close action."""
...
def test_handle_dock_closed_shows_docked_widget_without_readding() -> None:
    """Reveal already docked widgets without another shell insertion."""
...
def _application() -> QApplication:
    """Return the active QApplication required for widget construction."""
