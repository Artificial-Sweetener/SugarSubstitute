...
def test_tab_selection_autosave_restarts_legacy_timer_before_dispatch() -> None:
    """Restart the legacy tab-selection timer before requesting autosave."""

    calls: list[tuple[str, object]] = []
    shell = SimpleNamespace(
        _tab_selection_autosave_timer=SimpleNamespace(
...
def test_categorized_autosave_prefers_composed_coordinator_to_fallback() -> None:
    """Use the composed coordinator without invoking the legacy fallback route."""
