...
def test_cube_loading_targets_original_workflow_despite_tab_switch() -> None:
    ...
    class FakeQTimer:
        ...
        @staticmethod
        def singleShot(_ms: int, func: Callable[[], None]) -> None:
    ...
    class _FakeCubeLoadService:
        ...
        def load_cube_definition(self, cube_id: str) -> Any:
    ...
    class FakeTabItem:
        ...
        def setRouteKey(self, new: str) -> None:
    ...
    class FakeCubeStack:
        ...
        def setTabIcon(self, _index: int, _icon: object) -> None:
            """Accept tab icon updates."""

        def tabItem(self, index: int) -> FakeTabItem:
            """Return one tab item."""
    ...
    main_window: Any = FakeMainWindow()
    execution_submitter: Any = FakeExecutionSubmitter()
    ...
    callbacks = cube_loader.CubeLoadUiCallbacks(
        ...
        schedule_next_gui_turn=FakeQTimer.queue.append,
    )
