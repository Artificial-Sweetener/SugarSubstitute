...
def test_progress_registry_replays_latest_selected_projection_to_late_strip(
...
def test_progress_registry_respects_local_visibility_gate(
    generation_progress_strip: GenerationProgressStrip,
) -> None:
...
def test_progress_registry_unregister_stops_future_updates(
    generation_progress_strip: GenerationProgressStrip,
) -> None:
...
def test_progress_registry_replays_late_strip_without_animation(
    generation_progress_strip: GenerationProgressStrip,
) -> None:
