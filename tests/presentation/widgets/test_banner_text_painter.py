...
"""Verify banner-backed text painting contracts for shared widgets."""
...
def test_banner_text_painter_applies_wash_over_banner(
...
def test_banner_text_painter_cover_crops_without_stretching(
    qt_application_owner: QApplication,
) -> None:
...
def test_banner_text_painter_paints_fallback_without_banner(
    qt_application_owner: QApplication,
) -> None:
...
def test_banner_text_painter_shadowed_text_paints_visible_pixels(
    qt_application_owner: QApplication,
) -> None:
