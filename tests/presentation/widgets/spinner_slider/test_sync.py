...
def test_integer_spinner_slider_synchronizes_both_controls(
...
def test_integer_spinner_slider_projection_moves_fluent_handle_with_fill(
    qt_application_owner: QApplication,
) -> None:
...
def test_decimal_spinner_slider_preserves_decimal_values_and_suffix(
    qt_application_owner: QApplication,
) -> None:
