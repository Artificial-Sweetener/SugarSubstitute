...
def test_pending_restart_toolbar_button_starts_hidden(
...
def test_pending_restart_copy_retranslates_without_recreating_button(
...
def test_pending_restart_toolbar_button_shows_count(
    restart_owner: RestartPresentationOwner,
) -> None:
...
def test_pending_restart_toolbar_button_emits_activated_on_click(
    restart_owner: RestartPresentationOwner,
) -> None:
...
def test_pending_restart_toolbar_button_collapses_balance_when_search_hidden(
    restart_owner: RestartPresentationOwner,
) -> None:
    """Toolbar balance spacer should not reserve width outside Settings search."""

    toolbar = restart_owner.own_widget(QWidget())
...
def test_pending_restart_toolbar_button_expands_balance_when_search_has_room(
    restart_owner: RestartPresentationOwner,
) -> None:
...
def test_pending_restart_toolbar_button_collapses_balance_when_visible(
    restart_owner: RestartPresentationOwner,
) -> None:
...
def test_pending_restart_toolbar_button_collapses_balance_when_width_starved(
    restart_owner: RestartPresentationOwner,
) -> None:
...
def test_pending_restart_toolbar_button_hides_alignment_spacer_when_starved(
    restart_owner: RestartPresentationOwner,
) -> None:
    """Zero-width toolbar spacers must not leave layout spacing when starved."""

    reference_toolbar = restart_owner.own_widget(QWidget())
    ...
    activate_widget_layouts(reference_toolbar)
    ...
    activate_widget_layouts(toolbar)
...
def test_pending_restart_toolbar_button_shows_alignment_spacer_with_room(
    restart_owner: RestartPresentationOwner,
) -> None:
...
def test_pending_restart_toolbar_button_ignores_stale_stretched_control_width(
    restart_owner: RestartPresentationOwner,
) -> None:
