...
"""Verify workflow-domain policy behavior and dependency purity."""
...
def test_stack_manager_set_state_copies_collections() -> None:
    """Protect stack state from caller-side mutation after assignment."""
...
def test_stack_manager_from_dict_defaults_when_keys_missing() -> None:
    """Deserialize absent fields to empty defaults."""
...
def test_domain_workflow_modules_do_not_import_qt_dependencies() -> None:
    """Keep domain workflow modules free of presentation dependencies."""
