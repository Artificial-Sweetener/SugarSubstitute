...
"""Decode concise test inputs into typed node-behavior payloads."""
...
def _enum_or_none(enum_type: type[EnumT], value: object) -> EnumT | None:
    """Return an enum member when the input string matches."""
...
def _coerce_title_controls(value: object) -> tuple[TitleControl, ...] | None:
    """Normalize a list-like title-control value."""
...
def _coerce_field_presentation(
    *,
    ...
    """Normalize presentation and custom-control ownership."""
...
def _decode_field_patch(raw: object) -> FieldBehaviorPatch:
    """Decode one typed field patch from concise test input."""
...
def _decode_card_patch(raw: object) -> CardBehaviorPatch:
    """Decode one typed card patch from concise test input."""
...
def _decode_node_patch(raw: object) -> NodeBehaviorPatch:
    """Decode one typed node patch from concise test input."""
...
def behavior_payload(raw: object) -> PackageBehaviorPatch:
