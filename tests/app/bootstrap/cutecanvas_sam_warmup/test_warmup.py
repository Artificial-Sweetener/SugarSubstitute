...
"""Tests for launch-splash CuteCanvas SAM dependency warmup."""
...
import substitute.app.bootstrap.cutecanvas_sam_startup_warmup as warmup_module
...
_REPOSITORY_ROOT = Path(warmup_module.__file__).resolve().parents[3]
