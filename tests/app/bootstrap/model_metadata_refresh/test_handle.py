...
class _FakeProgressSink:
    ...
    def __init__(self) -> None:
        """Initialize recorded stable and transient output."""
...
class _FakeService:
    ...
    def refresh(
        ...
        *,
        ...
        """Record refresh execution and emit one complete status line."""
...
def test_startup_refresh_handle_releases_splash_when_refresh_finishes() -> None:
    """Release the splash after immediately completed metadata refresh work."""
...
def test_startup_refresh_handle_releases_splash_after_budget() -> None:
    """Release the splash at the injected budget deadline and close on shutdown."""
