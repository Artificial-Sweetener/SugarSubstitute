...
def test_canvas_only_forwards_every_anchor_without_resampling(
    ...
    _drain_until(app, lambda: len(results) == 1)
...
def test_real_cutecanvas_resamples_every_regional_mask_and_undoes_atomically() -> None:
    ...
    try:
        ...
        _drain_until(app, lambda: bool(results), timeout=5.0)
...
def _drain_until(
    ...
    *,
    ...
    """Pump Qt delivery until one bounded terminal condition is observed."""
