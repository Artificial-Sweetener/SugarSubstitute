...
def test_queue_prompt_returns_prompt_id_when_payload_is_valid(
...
def test_queue_prompt_posts_preview_method_extra_data(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_queue_prompt_posts_partial_execution_targets(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_queue_prompt_posts_ui_workflow_pnginfo(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_queue_prompt_preserves_prompt_validation_error_payload(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_queue_prompt_reports_missing_backend_queue_capability(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_gateway_result_carries_prompt_validation_report(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_interrupt_returns_sent_status_on_http_200(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_interrupt_returns_failed_status_when_transport_raises(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_get_queue_extracts_prompt_ids_from_comfy_response(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_delete_pending_prompt_posts_delete_payload(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
