...
"""Verify direct Comfy workflow loading from JSON and PNG metadata."""
...
def test_repository_loads_comfy_workflow_json(tmp_path: Path) -> None:
    """Load direct Comfy workflows from JSON files."""
...
def test_repository_loads_workflow_only_png_metadata(tmp_path: Path) -> None:
    """Load PNG workflow metadata when no SugarScript is attached."""
...
def test_repository_rejects_png_workflow_when_sugar_script_is_attached(
    ...
    """Keep SugarScript PNGs out of the direct Comfy load path."""
...
def test_repository_rejects_png_without_supported_workflow_metadata(
    ...
    """Keep generic PNG files out of the direct Comfy workflow loader."""
