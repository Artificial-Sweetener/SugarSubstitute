...
"""Verify deferred editor layout work tolerates Qt-owner teardown."""
...
def test_node_card_width_sync_returns_after_surface_deletion() -> None:
    """A queued node-card callback must not inspect its deleted C++ surface."""
...
def test_cube_section_width_sync_returns_after_section_deletion() -> None:
    """A queued cube-section callback must not inspect its deleted C++ owner."""
