...
"""Test central Substitute BackEnd compatibility policy."""
...
def test_compatibility_blocks_too_old_backend() -> None:
    ...
    assert result.required_backend_version == "1.10.0"
...
def test_compatibility_blocks_sugarcubes_before_required_release() -> None:
    ...
    assert result.repairable is True
    assert result.required_sugarcubes_version == "0.14.10"
...
def test_compatibility_keeps_backend_exact_but_accepts_newer_sugarcubes() -> None:
    ...
    sugarcubes_result = _service(_capabilities(sugar_cubes_version="0.14.10")).assess()
...
def _capabilities(
    *,
    ...
    sugar_cubes_version: str = "0.14.10",
