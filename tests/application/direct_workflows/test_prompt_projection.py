...
"""Verify transient prompt projection on direct Comfy authoring state."""
...
def test_prompt_projector_lowers_detached_overlay_and_preserves_output_manifest() -> (
    ...
    """Lower transient values while retaining discovered output identity."""
    document = _document()
...
def test_prompt_field_overlay_rejects_stale_locators(
    ...
    """Reject stale locators with actionable authoring identities."""
