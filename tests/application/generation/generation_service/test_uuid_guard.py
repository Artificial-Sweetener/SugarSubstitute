...
"""Verify generation UUID wrapper guards."""
...
def test_find_unresolved_uuid_class_types_detects_wrapper_nodes() -> None:
    """Detect one repeated unresolved wrapper identifier."""
...
def test_find_unresolved_uuid_class_types_ignores_non_uuid_classes() -> None:
    """Ignore class types that are not unresolved wrapper identifiers."""
