...
import substitute.application.generation.live_event_projection as projection_module
...
def test_live_event_scene_fields_returns_scene_identity_fields() -> None:
    """Expose logging-ready scene fields for scene-routed live events."""
...
def test_live_event_scene_fields_returns_empty_fields_for_source_only_events() -> None:
    """Project empty scene fields for source-only live events."""
...
def test_live_event_projection_import_boundary() -> None:
    """Keep live-event projection independent of Qt and presentation modules."""
