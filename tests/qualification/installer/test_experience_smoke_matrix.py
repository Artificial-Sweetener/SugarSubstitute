...
def test_headless_smoke_renders_complete_matrix_without_side_effects() -> None:
    ...
    assert {
        ...
        "comfy-setup/managed-existing-sdxl/recommendations-upscalers",
        "comfy-setup/managed-existing-sdxl/completion",
        "comfy-setup/managed-existing-anima/recommendations-sdxl",
        "comfy-setup/managed-existing-anima/recommendations-upscalers",
        ...
        "comfy-setup/managed-decline-model/recommendations-upscalers",
        ...
        "comfy-setup/managed-sdxl-and-anima/recommendations-upscalers",
