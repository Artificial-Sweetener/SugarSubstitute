...
"""Qualify packaged Chinese and Japanese application text through real Qt QMs."""
...
_RESOURCE_ROOT = _PROJECT_ROOT / "substitute" / "presentation" / "resources" / "i18n"
...
def test_catalog_extraction_includes_every_explicit_conditional_message() -> None:
    ...
    sources = {
        message.source for message in extract_application_messages(_PROJECT_ROOT)
    }
