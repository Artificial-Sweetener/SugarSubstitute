...
"""Guard trailing projection-document transitions at their focused owner."""
...
from tests.prompt_projection_invariants import validate_prompt_projection_document
