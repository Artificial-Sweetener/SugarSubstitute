...
@pytest.fixture
def owner(qt_application_owner: QApplication) -> Iterator[_Owner]:
    """Yield one tooltip owner with a fixture-managed Qt lifetime."""
...
@pytest.fixture
def watched(qt_application_owner: QApplication) -> Iterator[_Watched]:
    """Yield one watched widget with a fixture-managed Qt lifetime."""
...
def test_fluent_tooltip_filter_uses_one_owner_filter_for_targets(
    owner: _Owner,
    watched: _Watched,
) -> None:
...
def test_dynamic_tooltip_text_does_not_reset_specialized_filter_policy(
    owner: _Owner,
) -> None:
...
def test_fluent_tooltip_filter_shows_tooltip_at_event_cursor_position(
    owner: _Owner,
) -> None:
...
def test_fluent_tooltip_filter_clamps_qfluent_tooltip_width(
    owner: _Owner,
) -> None:
...
def test_fluent_tooltip_filter_suppresses_native_tooltip_event(
    owner: _Owner,
) -> None:
...
def test_fluent_tooltip_window_never_accepts_or_steals_focus(
    owner: _Owner,
) -> None:
...
def test_fluent_tooltip_filter_hides_on_dismissal_events(owner: _Owner) -> None:
...
def test_fluent_tooltip_filter_does_not_show_without_tooltip_text(
    owner: _Owner,
) -> None:
...
def test_fluent_tooltip_filter_skips_disabled_owner_by_default(
    owner: _Owner,
) -> None:
...
def test_fluent_tooltip_filter_can_show_disabled_owner_tooltip(
    owner: _Owner,
) -> None:
...
def test_fluent_tooltip_filter_preserves_disabled_owner_opt_in(
    owner: _Owner,
) -> None:
