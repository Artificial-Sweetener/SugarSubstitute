...
"""Cover the Qt-free localization contract shared by every executable."""
...
def test_language_manifest_defines_release_languages_as_data() -> None:
    ...
    assert manifest.language("es").comfy_catalog_aliases == ("es",)
    assert manifest.language("es").font_profile == "system"
