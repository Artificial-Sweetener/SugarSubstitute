...
<p align="center">
  <a href="https://github.com/Artificial-Sweetener/SugarSubstitute/releases/latest"><img src="https://img.shields.io/github/v/release/Artificial-Sweetener/SugarSubstitute?filter=v%2A" alt="Última versión"></a>
...
**SugarSubstitute está en beta pública.** Windows x64 es actualmente la única plataforma con soporte activo.

**[Descarga la última beta](#instalación)** para Windows x64.
...
### Linux y macOS: soporte suspendido temporalmente

El soporte, las compilaciones y la validación automatizada de Linux y macOS están suspendidos temporalmente. Por ahora no contamos con personas dedicadas a probar estas plataformas. Queremos retomar el soporte cuando el responsable del proyecto pueda validarlas; aún no hay fecha de reanudación. Los paquetes anteriores no están validados y no recomendamos utilizarlos.
...
- **CSV Wildcards:** gracias a [illuminatianon](https://github.com/illuminatianon) por crear [comfyui-csvwildcards](https://github.com/illuminatianon/comfyui-csvwildcards). SugarSubstitute vuelve a implementar su formato de comodines y desarrolla sus ideas para comodines basados en texto plano y CSV. Agradezco haber podido aprender de su trabajo.
...
- **Danbooru:** el equipo y la comunidad de [Danbooru](https://danbooru.donmai.us/) han creado un lenguaje compartido muy cuidado para describir imágenes. Su API permite aprovechar ese conocimiento dentro de SugarSubstitute, pero el verdadero regalo es el cuidado que la comunidad sigue dedicando a organizar, documentar y perfeccionar las propias etiquetas.
