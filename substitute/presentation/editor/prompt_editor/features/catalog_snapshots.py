...
PHASE23_CATALOG_FOREGROUND_INVENTORY: tuple[CatalogForegroundPathInventoryItem, ...] = (
    ...
    CatalogForegroundPathInventoryItem(
        ...
        current_path="prompt_editor/features/wildcard_autocomplete.py",
        lookup_token="search_wildcards(",
        classification=CatalogLookupClassification.FORBIDDEN_FOREGROUND,
        snapshot_owner="features/catalog_snapshots.py::Wildcard autocomplete snapshot owner",
        sub_phase="23.5",
        baseline_test="tests/test_prompt_wildcard_presentations.py",
    ),
    CatalogForegroundPathInventoryItem(
    ...
    CatalogForegroundPathInventoryItem(
        ...
        current_path="panel/dimension_presets/catalog_source.py",
        lookup_token="prepare_dimension_preset_catalog(",
        classification=CatalogLookupClassification.FORBIDDEN_FOREGROUND,
        snapshot_owner="panel/dimension_presets/catalog_source.py",
        sub_phase="23.7",
