...
"""Build prompt-aware context insertion against projection command owners."""
...
def build_context_insertion_service(
    ...
    *,
    ...
    """Build context insertion around the authoritative projection commands."""
    return PromptContextInsertionService(
        source_commands=projection.source_commands,
        trigger_word_commands=projection.trigger_word_commands,
        ...
        structured_text_mutations=projection.structured_text_mutations,
    )
