...
class AudioRecordField(QWidget):
    ...
    def __init__(self, value: object, parent: QWidget | None = None) -> None:
        ...
        self.status_label = LocalizedCaptionLabel(self)
    ...
    def _start_recording(self) -> None:
        ...
        if not QMediaDevices.audioInputs():
            self.status_label.setText(app_text("No microphone"))
    ...
    def _recording_state_changed(self, state: QMediaRecorder.RecorderState) -> None:
        ...
        if is_recording:
            self.status_label.setText(app_text("Recording…"))
            return
    ...
    def _recording_failed(
        ...
        self.status_label.setText(app_text("Recording failed"))
        set_fluent_tooltip_text(self.status_label, message)
    ...
    def _choose_audio_file(self) -> None:
        ...
        selected, _filter = QFileDialog.getOpenFileName(
            self,
            translate_application_message("Choose audio"),
            "",
            translate_application_message(
    ...
    def _refresh_status(self) -> None:
        ...
        self.status_label.setText(
            Path(self._value).name if self._value else app_text("No audio")
        )
        set_fluent_tooltip_text(self.status_label, self._value or "")
