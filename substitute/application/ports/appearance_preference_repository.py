...
"""Define appearance preference persistence contract."""

from __future__ import annotations

from typing import Protocol, runtime_checkable

from substitute.domain.appearance import AppearancePreferences


@runtime_checkable
class AppearancePreferenceRepository(Protocol):
    """Persist and load user appearance preferences."""
...
__all__ = ["AppearancePreferenceRepository"]
