...
_LAZY_EXPORTS = {
    ...
    "OutputTransferFormat": "substitute.domain.generation",
    "OutputTransferSettings": "substitute.domain.generation",
    "VideoHardwareDecoding": "substitute.domain.generation",
    "VideoPlaybackSettings": "substitute.domain.generation",
    "VideoRenderer": "substitute.domain.generation",
    "JpegOutputSettings": "substitute.domain.generation",
    "JpegSizingMode": "substitute.domain.generation",
    "effective_output_transfer_format": "substitute.domain.generation",
    "OutputRunProjectionCacheKeyProvider": (
        "substitute.application.generation.job_queue_service"
    ),
