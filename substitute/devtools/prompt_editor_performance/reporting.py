...
def _result_cells(result: ScenarioResult) -> tuple[str, ...]:
    ...
    return (
        ...
        str(counters.document_view_build.count),
        str(counters.syntax_render_plan_build.count),
        str(counters.projection_document_build.count),
        ...
        f"{diagnostics_ms:.2f}",
        str(counters.diagnostics_visible_publish.count),
        f"{menu_ms:.2f}",
        ...
        str(counters.danbooru_import_apply.count),
        ...
        str(counters.projection_pending_flush_applied.count),
